...
export async function getManagementWorkbenchDistrict(code: React.Key) {
  return request<API.RequestResult>(
    `/management/hospital/workbench/patient/child/district/${code}`,
    {
      method: 'GET',
    },
  );
...
export async function getStudentWarningArchiveList(
  id: React.Key,
...
export async function getStudentPreschoolCheckList(
  params?: API.ObjectType,
  options?: API.ObjectType,
) {
...
export async function getStudentPreschoolCheckInfo(
  params?: API.ObjectType,
  options?: API.ObjectType,
) {
